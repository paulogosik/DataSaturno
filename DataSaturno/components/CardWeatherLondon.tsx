...
export function CardWeatherLondon() {
        ...
        async function fetchWeather() {
            try {
                const response = await fetch(
                    'https://api.openweathermap.org/data/2.5/weather?q=London&appid=767190045fa5f85d2eb36cd53d69583e&units=metric&lang=pt_br'
                );
